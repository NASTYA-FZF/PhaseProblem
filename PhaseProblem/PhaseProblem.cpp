...
// PhaseProblem.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CPhaseProblemApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CPhaseProblemApp

CPhaseProblemApp::CPhaseProblemApp()
{
...
// Единственный объект CPhaseProblemApp

CPhaseProblemApp theApp;


// Инициализация CPhaseProblemApp

BOOL CPhaseProblemApp::InitInstance()
{
